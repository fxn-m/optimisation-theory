...
This readme is intended to provide the user with information on usage of the dynamic programming problem solvers network.py and capbud.py

Note: Running both programs will output text to the terminal, but the log .txt files contains all relevant information in a more interpretable form.
